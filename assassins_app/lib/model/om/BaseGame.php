...
abstract class BaseGame extends BaseObject  implements Persistent {
  ...
  const PEER = 'GamePeer';
	...
	/**
	 * The value for the active_players field.
	 * @var        int
	 */
	protected $active_players;
	...
	/**
	 * Initializes internal state of BaseGame object.
	 * @see        applyDefaults()
	 */
	...
	/**
	 * Get the [active_players] column value.
	 * 
	 * @return     int
	 */
	...
	public function setStartTime($v)
	{
		...
		if ( $this->start_time !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = GamePeer::START_TIME;
			}
	...
	public function setEndTime($v)
	{
		...
		if ( $this->end_time !== null || $dt !== null ) {
					...
					)
			{
				...
				$this->modifiedColumns[] = GamePeer::END_TIME;
			}
		} // if either are not null
	...
	/**
	 * Set the value of [active_players] column.
	 * 
	 * @param      int $v new value
	 * @return     Game The current object (for fluent API support)
	 */
	public function setActivePlayers($v)
	{
		if ($v !== null) {
			$v = (int) $v;
		}

		if ($this->active_players !== $v) {
			$this->active_players = $v;
			$this->modifiedColumns[] = GamePeer::ACTIVE_PLAYERS;
		}
	...
	public function setLatitude($v)
	{
		...
		if ($this->latitude !== $v) {
			$this->latitude = $v;
			$this->modifiedColumns[] = GamePeer::LATITUDE;
		}
	...
	public function setLongitude($v)
	{
		...
		if ($this->longitude !== $v) {
			$this->longitude = $v;
			$this->modifiedColumns[] = GamePeer::LONGITUDE;
		}
	...
	public function setIsActive($v)
	{
		...
		if ($this->is_active !== $v) {
			$this->is_active = $v;
			$this->modifiedColumns[] = GamePeer::IS_ACTIVE;
		}
	...
	public function setIsPublic($v)
	{
		...
		if ($this->is_public !== $v) {
			$this->is_public = $v;
			$this->modifiedColumns[] = GamePeer::IS_PUBLIC;
		}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->start_time = ($row[$startcol + 1] !== null) ? (string) $row[$startcol + 1] : null;
			$this->end_time = ($row[$startcol + 2] !== null) ? (string) $row[$startcol + 2] : null;
			$this->active_players = ($row[$startcol + 3] !== null) ? (int) $row[$startcol + 3] : null;
			...
			$this->is_public = ($row[$startcol + 7] !== null) ? (boolean) $row[$startcol + 7] : null;
			$this->resetModified();
			...
			return $startcol + 8; // 8 = GamePeer::NUM_COLUMNS - GamePeer::NUM_LAZY_LOAD_COLUMNS).
	...
	public function fromArray($arr, $keyType = BasePeer::TYPE_PHPNAME)
	{
		...
		if (array_key_exists($keys[1], $arr)) $this->setStartTime($arr[$keys[1]]);
		if (array_key_exists($keys[2], $arr)) $this->setEndTime($arr[$keys[2]]);
		if (array_key_exists($keys[3], $arr)) $this->setActivePlayers($arr[$keys[3]]);
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(GamePeer::START_TIME)) $criteria->add(GamePeer::START_TIME, $this->start_time);
		if ($this->isColumnModified(GamePeer::END_TIME)) $criteria->add(GamePeer::END_TIME, $this->end_time);
		if ($this->isColumnModified(GamePeer::ACTIVE_PLAYERS)) $criteria->add(GamePeer::ACTIVE_PLAYERS, $this->active_players);
		if ($this->isColumnModified(GamePeer::LATITUDE)) $criteria->add(GamePeer::LATITUDE, $this->latitude);
		if ($this->isColumnModified(GamePeer::LONGITUDE)) $criteria->add(GamePeer::LONGITUDE, $this->longitude);
		if ($this->isColumnModified(GamePeer::IS_ACTIVE)) $criteria->add(GamePeer::IS_ACTIVE, $this->is_active);
		if ($this->isColumnModified(GamePeer::IS_PUBLIC)) $criteria->add(GamePeer::IS_PUBLIC, $this->is_public);
	 ...
	 * Otherwise if this Game has previously been saved, it will retrieve
	 * related Users from storage. If this Game is new, it will return
		...
		if ($this->collUsers === null) {
			if ($this->isNew()) {
			   $this->collUsers = array();
				...
				$criteria->add(UserPeer::CURRENT_GAME_ID, $this->id);
	 ...
	 * If this collection has already been initialized with an identical Criteria, it returns the collection.
	 * Otherwise if this Game has previously been saved, it will retrieve
	 * related GameMembers from storage. If this Game is new, it will return
	 * an empty collection or the current collection, the criteria is ignored on a new object.
	 *
	 * @param      PropelPDO $con
	 * @param      Criteria $criteria
		...
		if ($this->collGameMembers === null) {
			if ($this->isNew()) {
			   $this->collGameMembers = array();
				...
				$criteria->add(GameMemberPeer::GAME_ID, $this->id);
	 ...
	 */
	public function getGameMembersJoinUser($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(GamePeer::DATABASE_NAME);
		}
		...
		if ($this->collGameMembers === null) {
			if ($this->isNew()) {
				...
				$this->collGameMembers = GameMemberPeer::doSelectJoinUser($criteria, $con, $join_behavior);
			}
		} else {
			// the following code is to determine if a new query is
			// called for.  If the criteria is the same as the last
